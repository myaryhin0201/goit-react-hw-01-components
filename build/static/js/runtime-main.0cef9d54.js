!(function (e) {
  function t(t) {
    for (
      var n, l, p = t[0], c = t[1], i = t[2], f = 0, s = [];
      f < p.length;
      f++
    )
      (l = p[f]),
  ...
  (l.m = e),
    ...
    (l.p = '/goit-react-hw-01-components/');
  var p = (this.webpackJsonpcomponents = this.webpackJsonpcomponents || []),
    c = p.push.bind(p);
  (p.push = t), (p = p.slice());
...
//# sourceMappingURL=runtime-main.0cef9d54.js.map
